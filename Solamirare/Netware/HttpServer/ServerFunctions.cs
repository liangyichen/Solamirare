...
public static unsafe class ServerFunctions
{
    ...
    /// <returns></returns>
    public static bool InitContext(HTTPSeverConfig* config, UHttpContext* context, byte* responseBuffer)
    {
        ...
        if (bodyLength > 0)
            ...
            bodyBytes = UnManagedCollection<byte>.Empty;
    ...
    )
    {
        ...
        bool contextInit = InitContext(config, context, responseBuffer);
    ...
    public static bool DefaultUserLogic(UHttpContext* context)
    {
        ...
        context->Response.Write("Solamirare Server"u8);
        return true;
    }
