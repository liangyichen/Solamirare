...
public unsafe struct UHttpRequest
{
        ...
        )
    {
        ...
        if(bodyBytes is not null && !bodyBytes->IsEmpty)
        {

            Body = new UnManagedCollection<byte>(bodyBytes->InternalPointer, bodyBytes->Size);
        ...
        {
            Body = UnManagedCollection<byte>.Empty;
        }
