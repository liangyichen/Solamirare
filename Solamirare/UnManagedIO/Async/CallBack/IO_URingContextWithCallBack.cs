...
/// <summary>
/// Holds the state for an io_uring asynchronous file I/O callback request.
/// </summary>
[StructLayout(LayoutKind.Sequential)]
public unsafe struct IO_URingContextWithCallBack
{
    /// <summary>File descriptor associated with the request.</summary>
    public int fd;
    /// <summary>Kernel completion result.</summary>
    public int result;
