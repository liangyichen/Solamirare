...
public static unsafe partial class UnManagedStringHelper
{
    ...
    {
        UnManagedString str = UnManagedMemoryHelper.ParseFromDateTime(value);
    ...
    /// <param name="formatPattern">格式化方式</param>
    /// <returns>表示该时间的非托管字符串</returns>
    public static UnManagedString DateTimeToUnmanagedString(this DateTime value, ReadOnlySpan<char> formatPattern)
    {
        UnManagedString str = UnManagedMemoryHelper.ParseFromDateTime(value, formatPattern);
    ...
    /// </summary>
    /// <param name="value"></param>
    /// <param name="memory">表示该时间的非托管字符串</param>
    /// <param name="formatPattern">格式化方式</param>
    /// <returns>是否转换成功</returns>
    public static bool DateTimeToUnmanagedString(this DateTime value, UnManagedString* memory, ReadOnlySpan<char> formatPattern)
    {
        return UnManagedMemoryHelper.ParseFromDateTime(value, memory, formatPattern);
    }

    /// <summary>
    /// 将 <see cref="DateTime"/> 转换为非托管字符串
    /// </summary>
    /// <param name="value">表示该时间的非托管字符串</param>
    /// <param name="memory"></param>
    /// <returns>是否转换成功</returns>
    public static bool DateTimeToUnmanagedString(this DateTime value, UnManagedString* memory)
    {
        return UnManagedMemoryHelper.ParseFromDateTime(value, memory);
    }
