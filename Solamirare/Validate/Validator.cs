...
namespace Solamirare
{
    ...
    public static class Validator
    {
        ...
        /// <returns></returns>
        public static bool IsCharsAndInt(string source)
        {
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static bool IsIntorFloat(string source)
        {
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static bool IsRemoteImageUrl(string source)
        {
        ...
        /// <returns></returns>
        public static bool RegexEmail(string emailAddress)
        {
        ...
        /// <returns></returns>
        public static bool RegexNickName(string nicknameString)
        {
        ...
        /// <returns></returns>
        public static bool IsNumberOfPrice(string priceStr)
        {
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static bool IsUrlName(string source)
        {
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        public static bool IsTagOrCatgoryString(string str)
        {
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static bool CheckUrlFormat(string source)
        {
        ...
        /// <returns></returns>
        public static bool HasLink(string content)
        {
        ...
        /// <returns></returns>
        public static string ReplaceAnchorToEmpty(string content, string optionContent="")
        {
            //目前过滤掉所有的超链接的内容
