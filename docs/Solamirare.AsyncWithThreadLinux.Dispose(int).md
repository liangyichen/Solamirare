### [Solamirare](Solamirare.md 'Solamirare').[AsyncWithThreadLinux](Solamirare.AsyncWithThreadLinux.md 'Solamirare\.AsyncWithThreadLinux')

## AsyncWithThreadLinux\.Dispose\(int\) Method
...
<a name='Solamirare.AsyncWithThreadLinux.Dispose(int).gracefulShutdownTimeoutMilliseconds'></a>
