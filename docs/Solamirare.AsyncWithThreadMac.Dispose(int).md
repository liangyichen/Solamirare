### [Solamirare](Solamirare.md 'Solamirare').[AsyncWithThreadMac](Solamirare.AsyncWithThreadMac.md 'Solamirare\.AsyncWithThreadMac')

## AsyncWithThreadMac\.Dispose\(int\) Method
...
<a name='Solamirare.AsyncWithThreadMac.Dispose(int).gracefulShutdownTimeoutMilliseconds'></a>
